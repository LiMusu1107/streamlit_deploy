...
class VCDN(nn.Module):
    def __init__(self, num_view, num_cls, hvcdn_dim, dropout_vcdn):
        super().__init__()
...
def init_model_dict(num_view, num_class, dim_list, dim_he_list, dim_hc, dropout_rate=0.5, dropout_vcdn = 0.1):
    model_dict = {}
    for i in range(num_view):
